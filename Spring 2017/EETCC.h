...
#define SUMMER_MINIMUM_TIME_USING_AIRCOND_ToutHI           10  //minutes   (for Modified: v2 spring)
#define SUMMER_MINIMUM_TIME_WITHOUT_USING_AIRCOND_ToutHI   10  //minutes   (for Modified: v2 spring)
#define SUMMER_MINIMUM_TIME_USING_AIRCOND_ToutLOW          10  //minutes   (for Modified: v2 spring)
#define SUMMER_MINIMUM_TIME_WITHOUT_USING_AIRCOND_ToutLOW  10  //minutes   (for Modified: v2 spring)

//#define SUMMER_MINIMUM_TIME_USING_AIRCOND_ToutHI           50  //minutes   (for Modified: v2 summer)
//#define SUMMER_MINIMUM_TIME_WITHOUT_USING_AIRCOND_ToutHI   30  //minutes   (for Modified: v2 summer)
//#define SUMMER_MINIMUM_TIME_USING_AIRCOND_ToutLOW          10  //minutes   (for Modified: v2 summer)
//#define SUMMER_MINIMUM_TIME_WITHOUT_USING_AIRCOND_ToutLOW  40  //minutes   (for Modified: v2 summer)
